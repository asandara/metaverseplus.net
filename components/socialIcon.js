...
function SocialIcon() {
  return (
    <div className="flex  space-x-5 justify-start md:justify-center mt-5">
      <Link href="https://twitter.com/Metaverseplus_" target="_blank">
        <svg
        ...
        >
          <g id="Group_27" data-name="Group 27" transform="translate(-0.385)">
            <circle
              id="Ellipse_12"
      ...
      <Link href="https://www.facebook.com/108162191856058/" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="37"
          height="39"
      ...
      <Link
        href="https://www.instagram.com/metaverseplus.studio/"
        target="_blank"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          ...
          className="cursor-pointer w-9 h-9"
        >
          <g id="Group_25" data-name="Group 25" transform="translate(-0.385)">
            <ellipse
              id="Ellipse_17"
